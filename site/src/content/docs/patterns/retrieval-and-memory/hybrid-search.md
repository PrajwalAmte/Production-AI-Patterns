...
- **[GraphRAG Pattern](/Production-AI-Patterns/patterns/retrieval-and-memory/graph-rag/)** — For relational queries where neither hybrid nor dense search is sufficient.
